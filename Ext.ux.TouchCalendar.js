...
Ext.define('Ext.ux.TouchCalendar',{
    ...
    initialize: function(){
        ...
        this.viewMode = this.viewMode.toUpperCase();

        this.initViews();
        console.log("fuck");
        console.log(this.enableEventBars);
        Ext.apply(this, {
            cls: 'touch-calendar',
    ...
    */
    ...
    initViews: function(){
        var items = [];
        var origCurrentDate = Ext.Date.clone(this.currentDate),
        ...
        items.push(
            new Ext.ux.TouchCalendarView(Ext.applyIf({
                currentDate: viewValue
            }, this.getConfig(viewValue)))
        );

        // active view
        items.push(
            new Ext.ux.TouchCalendarView(this.getConfig(origCurrentDate))
        );
    ...
    */
    ...
    /**
    * Changes the viewMode of the calendar to the specified string's value. Possible values are 'month', 'week' and 'day'.
    * @method
    * @returns {void}
    */
    setMode: function(viewMode){
        ...
        this.getItems().each(function(view, index){
            ...
            view.setViewMode(viewMode, true);
            view.refresh();
        }, this);
    },
    ...
    */
    ...
    console.log(this.enableSwipeNavigate);
        if (this.enableSwipeNavigate) {
            var items = this.getItems();
            console.log(items.indexOf(newCard));
            ...
            if (direction === 'forward') {
                ...
                var newCalendar = new Ext.ux.TouchCalendarView(this.getConfig(newCard.currentDate.add(Date[this.viewMode], 1)));
